...
urlpatterns = [
    ...
    path('step/2/', views.Step2DocumentUploadView.as_view(), name='step2'),
    path('step/3/', views.Step3FaceCaptureView.as_view(), name='step3'),
    path('step/4/', views.Step4LivenessView.as_view(), name='step4'),
